...
function Slider({ currentImageIndex }) {
  const sliderTitles = [
    ...
    "Fashion Freedom: Embrace Your Authenticity",
    "Fashion Connect: A Global Community",
    "Fashion Influence: Inspire and Be Inspired",
    "Fashion Earnings: Turn Passion into Profits",
  ];
